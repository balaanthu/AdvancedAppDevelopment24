  ...
  return (
    <div className={`dashboard ${isSidePanelOpen ? 'side-panel-open' : ''}`}>
      <div className="side-panel">
        <div className="user-icon" onClick={toggleUserDropdown}>
          ...
          {isUserDropdownOpen && (
            <div className="user-dropdown">
              <p>Username</p>
              <Link to="/Home"><button onClick={() => console.log('Logout')}>Logout</button></Link>
            </div>
          )}
        </div>
        ...
        {/* <Link to="/MyEnquiries" className="side-panel-button">
          Get my enquiry
        </Link> */}
        <Link to="/DeleteEnquiries" className="side-panel-button">
          Delete Enquiry
        </Link>
      </div>
